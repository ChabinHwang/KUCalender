public class Schedule {
    ...
    public void printScheduleAddMemo(){
        ...
        switch(cycleType){
            ...
            case -2:
            	printSchedule();
                System.out.println("매월 "+FileManager.getDayOfYear(partDate[0])+"일 "+partTime[0]+" ~ ("+FileManager.calculateDateDifference(partDate[0],partDate[1])+"일 뒤) "+FileManager.getDayOfYear(partDate[1])+"일 "+partTime[1]+" - "+title);
                System.out.println("반복 기간 : "+partDate[0]+" ~ "+cycleHaltDate);
                if(memo==null){
                    System.out.println("메모 : ");
                }
